...
when ODIN_OS == .Linux do foreign import sqlite { "libsqlite3.a", "system:pthread", "system:dl" }
when ODIN_OS == .Darwin do foreign import sqlite { "libsqlite3.a", "system:pthread", "system:dl" }
